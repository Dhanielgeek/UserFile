...
import { extractNationalities} from './Components/Utils';
import './App.css';
  ...
  useEffect(() => {
    axios.get('https://randomuser.me/api/?results=50')
      .then(response => {
        ...
        setNationalities(extractNationalities(response.data.results));
      })
  ...
  return (
    <div className="w-[100%] h-[100vh] flex items-center flex-col">
      ...
      <div className='w-[100%] h-[9%] flex justify-start items-center px-5'>
        <Filter users={users} setFilteredUsers={setFilteredUsers} nationalities={nationalities} />
      </div>
